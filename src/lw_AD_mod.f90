...
contains
  ...
  subroutine lw_AD(nlay, nlev, nb, ng, gw, wn_e, Tl, pl, pe, tau_e, ssa, gg, a_surf, Tint, lw_up, lw_down, lw_net, olr)
    implicit none
    ...
    do b = 1, nb
      ...
      lw_down_b(b,:) = 0.0_dp
      do g = 1, ng
        call lw_adding_doubling(nlay, nlev, be(b,:), be_int(b), tau_e(g,b,:), ssa(g,b,:), gg(g,b,:), &
